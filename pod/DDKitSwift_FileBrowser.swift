...
extension String{
    var ZXLocaleString: String {
        guard let bundlePath = Bundle(for: DDKitSwift_FileBrowser.self).path(forResource: "DDKitSwift_FileBrowser", ofType: "bundle") else { return NSLocalizedString(self, comment: "") }
